                        ...
                        <div class="inner bg-light lter">
                              ...
                              <div class="box">
                                    <header>
                                        ...
                                        <div class="btn btn-default btn-sm minimize-box" style="float:right;:50%;">
                                             <a  href="javascript:;"class="btn" data-toggle="modal" data-target="#" style="font-size: 15px;" data-toggle="tooltip" title="Add" ng-click="addEvent()"><i class="fa fa-plus" aria-hidden="true"></i></a>
                                        </div>
                                        <div class="btn btn-default btn-sm minimize-box" style="float:right;:50%;">
