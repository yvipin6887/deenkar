...
<head>
    ...
    <link rel="stylesheet" href="<?php  echo base_url();?>asset/js/bootstrap.js" />  
        ...
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                <tr dir-paginate="user in users|itemsPerPage:5">
                    ...
                    <td>vipin</td>
                    <td>vipin@gmail.com</td>
                </tr><tr dir-paginate="user in users|itemsPerPage:5">
                    <td>1</td>
                    <td>vipin</td>
                    <td>vipin@gmail.com</td>
                </tr><tr dir-paginate="user in users|itemsPerPage:5">
...
<script type="text/javascript">
   $.ajax({
       type:"POST",
       url:base_url+'Pagination_agu/getallusers',
